...
public class TesteVenda2 {
    private IGenericDao<Venda> dao = new VendaDao("treinamento_hibernate2");
    private Integer idVenda;

    @Before
    public void criacaoVenda () {
        IGenericDao<Cliente> clienteDao = new ClienteDao("treinamento_hibernate2");
        IGenericDao<Produto> produtoDao = new ProdutoDao("treinamento_hibernate2");
        IGenericDao<VendaProduto> vendaProdutoDao = new VendaProdutoDao("treinamento_hibernate2");
